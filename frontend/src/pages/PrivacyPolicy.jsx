      ...
      <main className="relative min-h-screen overflow-hidden pt-32 p-8 text-left text-[#234451] z-10">
        ...
        <div className="relative z-10 bg-white/40 backdrop-blur-md p-6 rounded-xl shadow-md max-w-4xl mx-auto">
          ...
          <p className="text-sm mb-4">
            Materna (“we,” “us,” or “our”) is committed to protecting the
            privacy and data of every user who interacts with our platform. This
            Privacy Policy outlines how we collect, use, store, and safeguard
            your personal data through our website, mobile app, and any other
            digital interface we operate. By using our services, you agree to
          ...
          <p className="text-sm mb-2">
            When you interact with Materna's UI/UX, we may collect the following
          ...
          <ul className="list-disc pl-5 text-sm mb-2">
            ...
            <li>
              Interaction data (pages visited, buttons clicked, time spent,
              errors encountered)
            </li>
          </ul>
          ...
          <p className="text-sm mb-2">
            We may use cookies and similar technologies (e.g. local storage,
            session tracking) to improve your experience, remember your
            preferences, and personalize content. You may disable cookies in
          ...
          <ul className="list-disc pl-5 text-sm mb-2">
            ...
            <li>
              Provide insights to better support new moms (in aggregate,
              anonymized form)
            </li>
          </ul>
          <p className="text-sm mb-2">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-2">
            3. User-Generated Content and AI Tools
          </h2>
          <p className="text-sm mb-2">
            Some Materna features (e.g. Symptom SOS or chatbot) involve
            generating personalized responses or storing emotional/physical
            health insights. We treat these interactions as private, and only
            use them to:
          </p>
          <ul className="list-disc pl-5 text-sm mb-2">
            <li>Improve your personal experience</li>
            <li>
              Train or enhance our models in an anonymized, ethical way (only
              with your consent)
            </li>
          </ul>
          <p className="text-sm mb-2">
            You may delete your content at any time through your profile
            settings or by emailing us.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-2">
            4. Data Confidentiality & Access
          </h2>
          <p className="text-sm mb-2">
            Only authorized Materna team members and technical staff have access
            to your data, and solely for operational or support purposes. All
          ...
          <p className="text-sm mb-2">
            We use industry-standard security protocols to store and protect
            your data. This includes:
          </p>
          <ul className="list-disc pl-5 text-sm mb-2">
            <li>Encrypted HTTPS connections</li>
            <li>
              Secure cloud-based databases (e.g. Firebase, AWS, or equivalent)
            </li>
          ...
          <p className="text-sm mb-2">
            Materna is not intended for use by children under 13. We do not
          ...
          <p className="text-sm mb-2">
            ...
            technologies, or legal obligations. We’ll notify you via app alerts,
            email, or on-site notices. Continued use after an update means you
